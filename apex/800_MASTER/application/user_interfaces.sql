...
wwv_flow_imp_shared.create_user_interface(
 p_id=>wwv_flow_imp.id(13870473903420703)
,p_theme_id=>42
...
,p_navigation_list_template_id=>wwv_flow_imp.id(49589714481017658)
...
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(647073258002820)  -- LIST: NAVIGATION
,p_nav_bar_list_template_id=>wwv_flow_imp.id(15012979506185298)
