...
,p_last_upd_yyyymmddhh24miss=>'20231104182837'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10750352009399608)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(61783273582042378)
,p_plug_name=>'App Roles'
,p_parent_plug_id=>wwv_flow_imp.id(10750352009399608)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(61783553018042381)
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(691726189954932)
,p_region_id=>wwv_flow_imp.id(61783553018042381)
,p_layout_type=>'GRID'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10751820491399622)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10751072931399615)
,p_plug_name=>'User Profile [CARD]'
,p_parent_plug_id=>wwv_flow_imp.id(10751820491399622)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(49457424532017578)
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(10751197051399616)
,p_region_id=>wwv_flow_imp.id(10751072931399615)
,p_layout_type=>'ROW'
,p_title_adv_formatting=>false
...
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(10751970259399624)
,p_card_id=>wwv_flow_imp.id(10751197051399616)
,p_action_type=>'MEDIA'
,p_display_sequence=>10
,p_link_target_type=>'REDIRECT_PAGE'
,p_link_target=>'f?p=&APP_ID.:902:&SESSION.::&DEBUG.:902::'
,p_build_option_id=>wwv_flow_imp.id(642323038940525)
);
wwv_flow_imp_page.create_card_action(
 p_id=>wwv_flow_imp.id(10752113980399625)
,p_card_id=>wwv_flow_imp.id(10751197051399616)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(10751284221399617)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(11193385388308515)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(11193448373308516)
,p_plug_name=>'Street Credit [CHART]'
,p_parent_plug_id=>wwv_flow_imp.id(11193385388308515)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(11193555604308517)
,p_region_id=>wwv_flow_imp.id(11193448373308516)
,p_chart_type=>'dial'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(11193717921308518)
,p_chart_id=>wwv_flow_imp.id(11193555604308517)
,p_seq=>10
,p_name=>'Gauge'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(11193997708308521)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10988093432724426)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(10751284221399617)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(10860019762272009)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10989521994724440)
,p_name=>'P900_EDIT_PROFILE_HOT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(10751820491399622)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(10989561870724441)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10988218777724427)
,p_name=>'ON_CLOSE_IMAGE'
,p_event_sequence=>60
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10988093432724426)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10987892330724424)
,p_event_id=>wwv_flow_imp.id(10988218777724427)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10858845906271998)
,p_event_id=>wwv_flow_imp.id(10988218777724427)
,p_event_result=>'TRUE'
...
,p_affected_region_id=>wwv_flow_imp.id(10751072931399615)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10988470318724430)
,p_name=>'ON_CLOSE_PROFILE'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(10860019762272009)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10988578491724431)
,p_event_id=>wwv_flow_imp.id(10988470318724430)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10988768226724433)
,p_event_id=>wwv_flow_imp.id(10988470318724430)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
