...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49469468352017584)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2146627974182793)
,p_plug_template_id=>wwv_flow_imp.id(49469468352017584)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2146092823182792)
,p_plug_template_id=>wwv_flow_imp.id(49469468352017584)
,p_name=>'Sub Regions'
