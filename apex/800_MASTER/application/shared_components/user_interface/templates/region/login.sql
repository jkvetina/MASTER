...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49535370495017621)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2083094826182743)
,p_plug_template_id=>wwv_flow_imp.id(49535370495017621)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2082592282182742)
,p_plug_template_id=>wwv_flow_imp.id(49535370495017621)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2082159389182742)
,p_plug_template_id=>wwv_flow_imp.id(49535370495017621)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2081586887182742)
,p_plug_template_id=>wwv_flow_imp.id(49535370495017621)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2081111746182742)
,p_plug_template_id=>wwv_flow_imp.id(49535370495017621)
,p_name=>'Sub Regions'
