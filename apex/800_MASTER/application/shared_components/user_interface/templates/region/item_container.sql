...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49487117892017596)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2089774551182748)
,p_plug_template_id=>wwv_flow_imp.id(49487117892017596)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2089370702182748)
,p_plug_template_id=>wwv_flow_imp.id(49487117892017596)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2088823462182747)
,p_plug_template_id=>wwv_flow_imp.id(49487117892017596)
,p_name=>'Button Start'
