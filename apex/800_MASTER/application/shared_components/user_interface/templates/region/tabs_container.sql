...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49502113800017603)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2043177780182711)
,p_plug_template_id=>wwv_flow_imp.id(49502113800017603)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2042732467182711)
,p_plug_template_id=>wwv_flow_imp.id(49502113800017603)
,p_name=>'Tabs'
