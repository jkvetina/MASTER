...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(49489655991017597)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2077370120182738)
,p_plug_template_id=>wwv_flow_imp.id(49489655991017597)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2076801992182738)
,p_plug_template_id=>wwv_flow_imp.id(49489655991017597)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2076320457182738)
,p_plug_template_id=>wwv_flow_imp.id(49489655991017597)
,p_name=>'Sub Regions'
