...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(12398595604710713)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1798211467173701384)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1798212022185701385)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1805249384182260)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1804676538182259)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1804230304182258)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1803683740182257)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1803222778182257)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1804230304182258)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1798212022185701385)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1802714785182256)
,p_plugin_attribute_id=>wwv_flow_imp.id(1803222778182257)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1802126107182255)
,p_plugin_attribute_id=>wwv_flow_imp.id(1803222778182257)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1801538570182254)
,p_plugin_attribute_id=>wwv_flow_imp.id(1803222778182257)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1800899253182253)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1803222778182257)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1800393359182252)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1799942696182251)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1799429340182250)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1798920685182249)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1798405059182248)
,p_plugin_attribute_id=>wwv_flow_imp.id(1798920685182249)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1797862332182247)
,p_plugin_attribute_id=>wwv_flow_imp.id(1798920685182249)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1797249271182246)
,p_plugin_attribute_id=>wwv_flow_imp.id(1798920685182249)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1796619788182246)
,p_plugin_attribute_id=>wwv_flow_imp.id(1798920685182249)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1796019594182245)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(1803683740182257)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1798211467173701384)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1795523660182244)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1795071213182244)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1794529939182243)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1794166528182243)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1793616712182242)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1793090892182241)
,p_plugin_attribute_id=>wwv_flow_imp.id(1793616712182242)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1792495416182240)
,p_plugin_attribute_id=>wwv_flow_imp.id(1793616712182242)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1791915276182239)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1791381491182239)
,p_plugin_attribute_id=>wwv_flow_imp.id(1791915276182239)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1790787679182238)
,p_plugin_attribute_id=>wwv_flow_imp.id(1791915276182239)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1790242875182237)
,p_plugin_attribute_id=>wwv_flow_imp.id(1791915276182239)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1789661586182237)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1789158822182236)
,p_plugin_attribute_id=>wwv_flow_imp.id(1789661586182237)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1788540244182235)
,p_plugin_attribute_id=>wwv_flow_imp.id(1789661586182237)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1787938269182235)
,p_plugin_attribute_id=>wwv_flow_imp.id(1789661586182237)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1787336545182234)
,p_plugin_attribute_id=>wwv_flow_imp.id(1789661586182237)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1786720457182233)
,p_plugin_attribute_id=>wwv_flow_imp.id(1789661586182237)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1786076385182232)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1785578403182232)
,p_plugin_attribute_id=>wwv_flow_imp.id(1786076385182232)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1785073581182231)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1812620193228740990)
,p_plugin_id=>wwv_flow_imp.id(12398595604710713)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
