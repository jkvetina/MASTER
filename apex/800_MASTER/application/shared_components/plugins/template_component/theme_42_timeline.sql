...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(12335398577710656)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2145304154110924742)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2145304709122924743)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1777756830182206)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1777211094182205)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1776739856182204)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1776186133182204)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1775685882182203)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1775246031182202)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1774688198182200)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1775685882182203)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2145304709122924743)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1774266142182198)
,p_plugin_attribute_id=>wwv_flow_imp.id(1774688198182200)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1773613139182197)
,p_plugin_attribute_id=>wwv_flow_imp.id(1774688198182200)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1773031168182196)
,p_plugin_attribute_id=>wwv_flow_imp.id(1774688198182200)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1772469112182195)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1774688198182200)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1771940595182195)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1771453598182194)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1770883165182193)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1770384036182192)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1769889531182191)
,p_plugin_attribute_id=>wwv_flow_imp.id(1770384036182192)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1769304735182190)
,p_plugin_attribute_id=>wwv_flow_imp.id(1770384036182192)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1768711034182189)
,p_plugin_attribute_id=>wwv_flow_imp.id(1770384036182192)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1768130732182188)
,p_plugin_attribute_id=>wwv_flow_imp.id(1770384036182192)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1767528501182187)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(1775246031182202)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2145304154110924742)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1767050622182186)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1766539448182185)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1765990988182184)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1765494698182183)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1765038420182182)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1764509129182180)
,p_plugin_attribute_id=>wwv_flow_imp.id(1765038420182182)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1763952882182179)
,p_plugin_attribute_id=>wwv_flow_imp.id(1765038420182182)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1763360028182178)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1762787897182177)
,p_plugin_attribute_id=>wwv_flow_imp.id(1763360028182178)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1762265803182176)
,p_plugin_attribute_id=>wwv_flow_imp.id(1763360028182178)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1761639583182175)
,p_plugin_attribute_id=>wwv_flow_imp.id(1763360028182178)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1761033214182174)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1760558392182173)
,p_plugin_attribute_id=>wwv_flow_imp.id(1761033214182174)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1759941944182172)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1807188405173026194)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1921599768161289795)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2040631015135594236)
,p_plugin_id=>wwv_flow_imp.id(12335398577710656)
,p_name=>'Avatar Link'
