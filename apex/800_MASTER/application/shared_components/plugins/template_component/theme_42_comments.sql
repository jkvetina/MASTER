...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(12314046391710634)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1798017865248849299)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1866889428182414)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1866384657182413)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1865923248182412)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1865383324182411)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1864914491182410)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1857697643182399)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1798017865248849299)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1864392041182409)
,p_plugin_attribute_id=>wwv_flow_imp.id(1864914491182410)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1863849744182408)
,p_plugin_attribute_id=>wwv_flow_imp.id(1864914491182410)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1863238343182407)
,p_plugin_attribute_id=>wwv_flow_imp.id(1864914491182410)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1862639211182406)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(1864914491182410)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1862152218182406)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1861583376182405)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1861124859182404)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1860598808182404)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1860106440182403)
,p_plugin_attribute_id=>wwv_flow_imp.id(1860598808182404)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1859531732182402)
,p_plugin_attribute_id=>wwv_flow_imp.id(1860598808182404)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1858874373182401)
,p_plugin_attribute_id=>wwv_flow_imp.id(1860598808182404)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1858368279182400)
,p_plugin_attribute_id=>wwv_flow_imp.id(1860598808182404)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1857697643182399)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1857239085182398)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1856753863182396)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1856177263182395)
,p_plugin_attribute_id=>wwv_flow_imp.id(1856753863182396)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(1855603221182394)
,p_plugin_attribute_id=>wwv_flow_imp.id(1856753863182396)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(1854975296182393)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1812332390541843853)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1812331799036836396)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1812387422706818275)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1812539640419689046)
,p_plugin_id=>wwv_flow_imp.id(12314046391710634)
