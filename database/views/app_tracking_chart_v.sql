...
SELECT
    ...
    --
    app.get_color(x.color_name, t.t00) AS t00_color,    app.get_color(x.color_name, t.t00, 'Y') AS t00_text,
    app.get_color(x.color_name, t.t01) AS t01_color,    app.get_color(x.color_name, t.t01, 'Y') AS t01_text,
    app.get_color(x.color_name, t.t02) AS t02_color,    app.get_color(x.color_name, t.t02, 'Y') AS t02_text,
    app.get_color(x.color_name, t.t03) AS t03_color,    app.get_color(x.color_name, t.t03, 'Y') AS t03_text,
    app.get_color(x.color_name, t.t04) AS t04_color,    app.get_color(x.color_name, t.t04, 'Y') AS t04_text,
    app.get_color(x.color_name, t.t05) AS t05_color,    app.get_color(x.color_name, t.t05, 'Y') AS t05_text,
    app.get_color(x.color_name, t.t06) AS t06_color,    app.get_color(x.color_name, t.t06, 'Y') AS t06_text,
    app.get_color(x.color_name, t.t07) AS t07_color,    app.get_color(x.color_name, t.t07, 'Y') AS t07_text,
    app.get_color(x.color_name, t.t08) AS t08_color,    app.get_color(x.color_name, t.t08, 'Y') AS t08_text,
    app.get_color(x.color_name, t.t09) AS t09_color,    app.get_color(x.color_name, t.t09, 'Y') AS t09_text,
    app.get_color(x.color_name, t.t10) AS t10_color,    app.get_color(x.color_name, t.t10, 'Y') AS t10_text,
    app.get_color(x.color_name, t.t11) AS t11_color,    app.get_color(x.color_name, t.t11, 'Y') AS t11_text,
    app.get_color(x.color_name, t.t12) AS t12_color,    app.get_color(x.color_name, t.t12, 'Y') AS t12_text,
    app.get_color(x.color_name, t.t13) AS t13_color,    app.get_color(x.color_name, t.t13, 'Y') AS t13_text,
    app.get_color(x.color_name, t.t14) AS t14_color,    app.get_color(x.color_name, t.t14, 'Y') AS t14_text,
    app.get_color(x.color_name, t.t15) AS t15_color,    app.get_color(x.color_name, t.t15, 'Y') AS t15_text,
    app.get_color(x.color_name, t.t16) AS t16_color,    app.get_color(x.color_name, t.t16, 'Y') AS t16_text,
    app.get_color(x.color_name, t.t17) AS t17_color,    app.get_color(x.color_name, t.t17, 'Y') AS t17_text,
    app.get_color(x.color_name, t.t18) AS t18_color,    app.get_color(x.color_name, t.t18, 'Y') AS t18_text,
    app.get_color(x.color_name, t.t19) AS t19_color,    app.get_color(x.color_name, t.t19, 'Y') AS t19_text,
    app.get_color(x.color_name, t.t20) AS t20_color,    app.get_color(x.color_name, t.t20, 'Y') AS t20_text,
    app.get_color(x.color_name, t.t21) AS t21_color,    app.get_color(x.color_name, t.t21, 'Y') AS t21_text,
    app.get_color(x.color_name, t.t22) AS t22_color,    app.get_color(x.color_name, t.t22, 'Y') AS t22_text,
    app.get_color(x.color_name, t.t23) AS t23_color,    app.get_color(x.color_name, t.t23, 'Y') AS t23_text,
    app.get_color(x.color_name, t.t24) AS t24_color,    app.get_color(x.color_name, t.t24, 'Y') AS t24_text,
    app.get_color(x.color_name, t.t25) AS t25_color,    app.get_color(x.color_name, t.t25, 'Y') AS t25_text,
    app.get_color(x.color_name, t.t26) AS t26_color,    app.get_color(x.color_name, t.t26, 'Y') AS t26_text,
    app.get_color(x.color_name, t.t27) AS t27_color,    app.get_color(x.color_name, t.t27, 'Y') AS t27_text,
    app.get_color(x.color_name, t.t28) AS t28_color,    app.get_color(x.color_name, t.t28, 'Y') AS t28_text,
    app.get_color(x.color_name, t.t29) AS t29_color,    app.get_color(x.color_name, t.t29, 'Y') AS t29_text,
    app.get_color(x.color_name, t.t30) AS t30_color,    app.get_color(x.color_name, t.t30, 'Y') AS t30_text,
    app.get_color(x.color_name, t.t31) AS t31_color,    app.get_color(x.color_name, t.t31, 'Y') AS t31_text,
    app.get_color(x.color_name, t.t32) AS t32_color,    app.get_color(x.color_name, t.t32, 'Y') AS t32_text,
    app.get_color(x.color_name, t.t33) AS t33_color,    app.get_color(x.color_name, t.t33, 'Y') AS t33_text,
    app.get_color(x.color_name, t.t34) AS t34_color,    app.get_color(x.color_name, t.t34, 'Y') AS t34_text,
    app.get_color(x.color_name, t.t35) AS t35_color,    app.get_color(x.color_name, t.t35, 'Y') AS t35_text,
    app.get_color(x.color_name, t.t36) AS t36_color,    app.get_color(x.color_name, t.t36, 'Y') AS t36_text
FROM t
CROSS JOIN x;
--
