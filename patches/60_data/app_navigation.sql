...
USING (
    SELECT 800 AS app_id, 0 AS page_id, NULL AS parent_id, NULL AS is_hidden, NULL AS is_reset, NULL AS order#, NULL AS col_id FROM DUAL UNION ALL
    ...
    SELECT 800 AS app_id, 835 AS page_id, 820 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 20 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 800 AS app_id, 840 AS page_id, 820 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 25 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 800 AS app_id, 850 AS page_id, 800 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 15 AS order#, 4 AS col_id FROM DUAL UNION ALL
    ...
    SELECT 800 AS app_id, 890 AS page_id, 880 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 20 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 800 AS app_id, 895 AS page_id, 880 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 25 AS order#, NULL AS col_id FROM DUAL UNION ALL
    ...
    SELECT 800 AS app_id, 901 AS page_id, 900 AS parent_id, 'Y' AS is_hidden, 'Y' AS is_reset, 10 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 800 AS app_id, 902 AS page_id, 900 AS parent_id, 'Y' AS is_hidden, 'Y' AS is_reset, NULL AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 800 AS app_id, 905 AS page_id, 900 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, NULL AS order#, NULL AS col_id FROM DUAL UNION ALL
    ...
    SELECT 800 AS app_id, 9995 AS page_id, 900 AS parent_id, 'Y' AS is_hidden, NULL AS is_reset, 15 AS order#, NULL AS col_id FROM DUAL UNION ALL
    SELECT 800 AS app_id, 9999 AS page_id, 900 AS parent_id, NULL AS is_hidden, NULL AS is_reset, 20 AS order#, NULL AS col_id FROM DUAL
) s
ON (
    t.app_id = s.app_id
