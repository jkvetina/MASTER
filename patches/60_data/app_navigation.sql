...
USING (
    ...
    SELECT 800 AS app_id, 850 AS page_id, 800 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 15 AS order#, 1 AS col_id FROM DUAL UNION ALL
    ...
    SELECT 800 AS app_id, 870 AS page_id, 800 AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 30 AS order#, 3 AS col_id FROM DUAL UNION ALL
    ...
    SELECT 800 AS app_id, 980 AS page_id, NULL AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 980 AS order#, NULL AS col_id FROM DUAL
) s
ON (
    t.app_id = s.app_id
