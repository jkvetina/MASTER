...
--
DECLARE
    in_table_name       CONSTANT VARCHAR2(30)   := 'APP\_%';
    in_columns          CONSTANT VARCHAR2(4000) := 'IS_ACTIVE,IS_ADMIN,IS_DEFAULT,IS_FAVORITE,CREATED_BY,CREATED_AT,UPDATED_BY,UPDATED_AT,DELETED_BY,DELETED_AT';
BEGIN
    FOR t IN (
        SELECT t.table_name
        FROM user_tables t
